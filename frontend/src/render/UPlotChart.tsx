...
// tokens for axis/grid colours so it follows light/dark. Reused by the rate-distortion and spectrum views.
...
export function UPlotChart({ data, series, axes, scales, height = 260, legend = true }: UPlotChartProps) {
  ...
  return <div ref={hostRef} className="il-uplot il-chart" />;
}
