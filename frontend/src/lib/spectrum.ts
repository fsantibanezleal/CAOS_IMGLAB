...
export const FAMILIES: RepFamily[] = [
  ...
  },
  {
    ...
    blurb_es: 'Un puñado de formas, trazos o curvas de Bezier. El caso editable más limpio: mueve una forma y la imagen la sigue.',
    edit: 'semantic',
    editLabel_en: 'semantic-local',
    editLabel_es: 'semántico-local',
    lane: 'mixed',
  ...
  },
  {
    ...
    blurb_es: 'Boceto, trazo o una descripción de texto hacia una imagen plausible; edita el prompt o el latente y observa cómo deriva.',
    edit: 'learned',
